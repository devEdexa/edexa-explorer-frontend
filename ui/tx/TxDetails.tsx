...
const TxDetails = () => {
  const { data, isPlaceholderData, isError, socketStatus, error } =
    useFetchTxInfo();
    ...
    <>
      ...
      >
        ...
        <TxDetailsActions
          ...
          isTxDataLoading={isPlaceholderData}
        />
        ...
        <DetailsInfoItem
          ...
          columnGap={3}
        >
          <AddressEntity address={data.from} isLoading={isPlaceholderData} />
